      ...
      <div className="row gy-4">
        <div className="col-md-7">
          ...
          <p className="text-justify" style={{ lineHeight: 1.8 }}>
            ...
            living room. It also has a spacious and fully equipped kitchen/dining
            room area also with its own bathroom.
          </p>
          <p className="mt-3" style={{ lineHeight: 1.8 }}>
            It is built with an idea to make a perfect space for three families
            who wish to spend a lovely time together while keeping their personal
            space. All of the living units have a TV, WiFi and an air
            conditioning unit.
          </p>
        </div>
            ...
            <tbody>
              {details.map(({ label, value }) => (
                <tr key={label} className="border-bottom">
                  <td className="text-muted ps-0" style={{ fontSize: "0.75rem", letterSpacing: "0.05em" }}>
                    {label}
                  </td>
